"builtin.module"() ({
  "pdl.pattern"() ({
    ...
    %5 = "pdl.operation"(%1, %4, %0) {attributeValueNames = [], opName = "arith.remsi", operand_segment_sizes = array<i32: 2, 0, 1>} : (!pdl.value, !pdl.value, !pdl.type) -> !pdl.operation
    ...
    %12 = "pdl.operation"(%9, %10, %11, %8) {attributeValueNames = ["predicate"], opName = "arith.cmpi", operand_segment_sizes = array<i32: 2, 1, 1>} : (!pdl.value, !pdl.value, !pdl.attribute, !pdl.type) -> !pdl.operation
    "pdl.rewrite"(%12) ({
      %13 = "pdl.operation"(%1, %8) {attributeValueNames = [], opName = "arith.trunci", operand_segment_sizes = array<i32: 1, 0, 1>} : (!pdl.value, !pdl.type) -> !pdl.operation
  ...
  "pdl.pattern"() ({
    ...
    %10 = "pdl.result"(%7) {index = 0 : i32} : (!pdl.operation) -> !pdl.value
    %11 = "pdl.attribute"() {value = 1 : i64} : () -> !pdl.attribute
    %12 = "pdl.operation"(%10, %9, %11, %8) {attributeValueNames = ["predicate"], opName = "arith.cmpi", operand_segment_sizes = array<i32: 2, 1, 1>} : (!pdl.value, !pdl.value, !pdl.attribute, !pdl.type) -> !pdl.operation
    "pdl.rewrite"(%12) ({
      %13 = "pdl.operation"(%1, %8) {attributeValueNames = [], opName = "arith.trunci", operand_segment_sizes = array<i32: 1, 0, 1>} : (!pdl.value, !pdl.type) -> !pdl.operation
      "pdl.replace"(%12, %13) {operand_segment_sizes = array<i32: 1, 1, 0>} : (!pdl.operation, !pdl.operation) -> ()
    }) {operand_segment_sizes = array<i32: 1, 0>} : (!pdl.operation) -> ()
  }) {benefit = 5 : i16, sym_name = "opt0_com_1"} : () -> ()
}) : () -> ()
