"builtin.module"() ({
  "pdl.pattern"() ({
    ...
    %1 = "pdl.attribute"() {value = 1 : i32} : () -> !pdl.attribute
    ...
    %5 = "pdl.operation"(%0, %4, %2) {attributeValueNames = [], opName = "arith.divsi", operand_segment_sizes = array<i32: 2, 0, 1>} : (!pdl.value, !pdl.value, !pdl.type) -> !pdl.operation
    "pdl.rewrite"(%5) ({
