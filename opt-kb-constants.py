...
"pdl.pattern"() ({
    ...
    %4 = "pdl.operation"(%1, %2, %3, %0) {attributeValueNames = ["kb"], opName = "$opName", operand_segment_sizes = array<i32: 2, 1, 1>} : (!pdl.value, !pdl.value, !pdl.attribute, !pdl.type) -> !pdl.operation
    "pdl.rewrite"(%4) ({
