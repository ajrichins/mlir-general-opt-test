"builtin.module"() ({
  "pdl.pattern"() ({
    ...
    "pdl.rewrite"(%10) ({
      %11 = "pdl.attribute"() {value = 0 : i32} : () -> !pdl.attribute
      %12 = "pdl.operation"(%1, %4, %11, %3) {attributeValueNames = ["predicate"], opName = "arith.cmpi", operand_segment_sizes = array<i32: 2, 1, 1>} : (!pdl.value, !pdl.value, !pdl.attribute, !pdl.type) -> !pdl.operation
      "pdl.replace"(%10, %12) {operand_segment_sizes = array<i32: 1, 1, 0>} : (!pdl.operation, !pdl.operation) -> ()
