"builtin.module"() ({
  "pdl.pattern"() ({
    ...
    %2 = "pdl.attribute"() {value = -1} : () -> !pdl.attribute
    ...
    %4 = "pdl.result"(%3) {index = 0} : (!pdl.operation) -> !pdl.value
    ...
    %6 = "pdl.attribute"() {value = 1} : () -> !pdl.attribute
    ...
    %8 = "pdl.result"(%5) {index = 0} : (!pdl.operation) -> !pdl.value
    %9 = "pdl.result"(%7) {index = 0} : (!pdl.operation) -> !pdl.value
