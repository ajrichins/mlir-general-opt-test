"builtin.module"() ({
  "pdl.pattern"() ({
    ...
    %5 = "pdl.attribute"() {value = 1 : i32} : () -> !pdl.attribute
    ...
    %7 = "pdl.attribute"() {value = true} : () -> !pdl.attribute
    %8 = "pdl.operation"(%7, %3) {attributeValueNames = ["value"], opName = "arith.constant", operand_segment_sizes = array<i32: 0, 1, 1>} : (!pdl.attribute, !pdl.type) -> !pdl.operation
    %9 = "pdl.result"(%6) {index = 0 : i32} : (!pdl.operation) -> !pdl.value
    %10 = "pdl.result"(%8) {index = 0 : i32} : (!pdl.operation) -> !pdl.value
    %11 = "pdl.operation"(%9, %10, %3) {attributeValueNames = [], opName = "arith.xori", operand_segment_sizes = array<i32: 2, 0, 1>} : (!pdl.value, !pdl.value, !pdl.type) -> !pdl.operation
    "pdl.rewrite"(%11) ({
      %12 = "pdl.attribute"() {value = 0 : i64} : () -> !pdl.attribute
      %13 = "pdl.operation"(%1, %4, %12, %3) {attributeValueNames = ["predicate"], opName = "arith.cmpi", operand_segment_sizes = array<i32: 2, 1, 1>} : (!pdl.value, !pdl.value, !pdl.attribute, !pdl.type) -> !pdl.operation
      "pdl.replace"(%11, %13) {operand_segment_sizes = array<i32: 1, 1, 0>} : (!pdl.operation, !pdl.operation) -> ()
